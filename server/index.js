...
io.on('connection', (socket) => {
    ...
    const qntrlListeners = {
        ...
        'startBulkCreateCards': qntrlHandler.handleStartBulkCreateCards, // Added new event
    };
