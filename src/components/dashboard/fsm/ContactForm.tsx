...
import { FsmContactFormData, FsmContactJobState } from '@/App';
...
interface ContactFormProps {
  ...
  onFormDataChange: (data: FsmContactFormData) => void;
...
export const ContactForm: React.FC<ContactFormProps> = ({
  ...
  const handleInputChange = (field: keyof FsmContactFormData, value: string | number) => {
    ...
    <Card className="shadow-medium hover:shadow-large transition-all duration-300">
      <CardHeader>
        <div className="flex items-center space-x-2">
          ...
          <CardTitle className="text-lg">Bulk Contact Creation</CardTitle>
        </div>
        <CardDescription>
          Add multiple contacts to your Zoho FSM project.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="lastName">Last Name (for all contacts)</Label>
                <Input
                  id="lastName"
              ...
              <div className="space-y-2">
                <Label htmlFor="delay" className="flex items-center space-x-2">
                  ...
                  <span>Delay Between Creations</span>
                </Label>
          ...
          <div className="pt-4 border-t border-border">
              {!isProcessing ? (
                <Button
                    ...
                    variant="premium"
                    size="lg"
                    disabled={!formData.emails.trim() || !formData.lastName.trim()}
                    className="w-full"
                >
