...
export const ContactResultsDisplay: React.FC<ResultsDisplayProps> = ({ 
  results, 
  isProcessing, 
  isComplete,
  totalToProcess,
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", "fsm-contact-results.csv");
  ...
  return (
    <Card className="shadow-medium hover:shadow-large transition-all duration-300">
      <CardHeader className="pb-4">
        ...
        <CardDescription>
          {isProcessing ? 'Creating contacts in real-time...' : 
           isComplete ? `All ${totalToProcess} contacts have been processed.` : 
           'View results below.'}
        </CardDescription>
      </CardHeader>
